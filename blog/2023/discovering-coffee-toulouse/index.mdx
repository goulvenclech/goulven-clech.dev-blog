...
I started with the inexpensive manual grinder found on Amazon, but even if it does the job, <u>I still recommend spending the few tens of euros needed to acquire the Timemore.</u> You will have more control over the thickness of the grind and a more homogeneous result. <annotation class="xl:-mt-2">July 2024:<br/>A posteriori, I think I did not emphasize that enough...</annotation><annotation class="">March 2025:<br/>A posteriori, I think this annotation is not clear enough...</annotation>
...
Here more info on <a href="https://youtu.be/1oB1oDrDkHM">how to use a <abbr>V60</abbr></a>.
