...
I started with the inexpensive manual grinder found on Amazon, but even if it does the job, <u>I still recommend spending the few tens of euros needed to acquire the Timemore.</u> You will have more control over the thickness of the grind and a more homogeneous result. <annotation>A posteriori, I think I did not emphasize that enough</annotation>
